...
VALUES  (1, 'Д','Дністровська1','ФОП','Ів.-фр. обл.', 0),
        (2, 'В','Дністровська2','ПП','Ів.-фр. обл.', 0),
...
VALUES (1, 'січень', 5 , 2, 0, 1, 5, 'ЗП за лютий', 100),
       (2, 'лютий', 5 , 2, 0, 1, 4, 'ЗП за березень', 100),
       (3, 'січень', 5 , 2, 0, 1, 3, 'ЗП за квітень', 100),
       (4, 'січень', 5 , 2, 0, 1, 2, 'ЗП за травень', 100);
...
VALUES  (1, 'січень', 5, 1, 100, 15.37, 42943.51, 0, 0, 0, 0, 42943.51),
        ...
        (4, 'січень', 5, 4, 100, 12.12, 18001.12, 0, 0, 0, 0, 18001.12),
        (5, 'лютий', 5, 1, 100, 15.37, 42943.51, 0, 0, 0, 0, 42943.51),
        (6, 'лютий', 5, 2, 100, 15.72, 9243.09, 0, 0, 0, 0, 9243.09),
        (7, 'лютий', 5, 7, 100, 0.00, 0.00, 0, 0, 0, 0, 0.00),
        (8, 'лютий', 5, 4, 100, 12.12, 18001.12, 0, 0, 0, 0, 18001.12);