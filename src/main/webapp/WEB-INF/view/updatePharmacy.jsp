...
<tiles:insertDefinition name="basetemplate">
    <tiles:putAttribute name="body">
        <c:url var="updateUrl" value="/pharmacy/update"/>
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Редагування аптеки</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form:form  class ="form-horizontal"  method="POST" modelAttribute="pharmacy" action="/pharmacy/update/${pharmacy.id}" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 checkbox">
                                    <input type="checkbox" id="calculationConsider" name="calculationConsider" class="form-control" value="1" <c:if test="${pharmacy.calculationConsider}"> checked </c:if> >
