...
<tiles:insertDefinition name="basetemplate">
    <tiles:putAttribute name="body">
        <c:url var="createUrl" value="/clause/"/>
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Створення статті доходів/витрат</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                    ...
                    <div class="panel-body">
                        <form:form  class ="form-horizontal"  method="POST" modelAttribute="incomeExpenseClause" action="${createUrl}" >
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 ">
                                    <input class="form-control" id="name" name="name" value="${incomeExpenseClause.name}">
