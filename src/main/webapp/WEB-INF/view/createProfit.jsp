...
<tiles:insertDefinition name="basetemplate">
    <tiles:putAttribute name="body">
        <c:url var="createUrl" value="/profit/"/>
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Створення доходу</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form:form  class ="form-horizontal"  method="POST" modelAttribute="profitForm" action="/profit/" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 ">
                                    <input class="form-control" id="PH" name="PH" value="${profitForm.PH}">
